package material.danny_jiang.com.xinxingmovie.manager;
 ...
 */
public class KShareElementManager {
    ...
    private static KShareElementManager INSTANCE;
     ...
     * @return
     */
    public static KShareElementManager getInstance(Activity activity) {
        ...
        INSTANCE = new KShareElementManager();
        return INSTANCE;
    ...
    public KShareElementManager withAction(KShareViewActivityAction action) {
        this.kShareViewActivityAction = action;
        return this;
    }

    public KShareElementManager setDuration(long duration) {
        this.duration = duration;
        return this;
    }

    public KShareElementManager withIntent(Intent intent) {
        this.mIntent = intent;
        return this;
    }

    public KShareElementManager withIntentAndRequestCode(Intent intent, int requestCode) {
        this.mIntent = intent;
